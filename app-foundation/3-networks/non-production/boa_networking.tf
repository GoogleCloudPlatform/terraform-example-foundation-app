...
resource "google_compute_firewall" "allow_lb_healthcheck" {
  ...
  target_service_accounts = ["tf-gke-gke-boa-us-east-huj0@prj-bu1-n-boa-gke-ecb0.iam.gserviceaccount.com"]
