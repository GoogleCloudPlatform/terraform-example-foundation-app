...
module "env" {
  ...
  boa_gke_nodes_gsa            = "boa-gke-nodes-d-gsa@${var.boa_gke_project_id}.iam.gserviceaccount.com"
  gke_cluster_1_cidr_block     = "100.64.78.0/28" # Cluster control plane same is defined in 3-networks/envs/development/boa_vpc_fw.tf
  gke_cluster_2_cidr_block     = "100.65.70.0/28" # Cluster control plane same is defined in 3-networks/envs/development/boa_vpc_fw.tf
